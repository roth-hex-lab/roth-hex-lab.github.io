...
On this paper Constantin Kleinbeck worked with Luisa Theelke (HEX, TUM), Hannah Schieber (HEX, TUM), Ulrich Eck (CAMP, TUM), Rüdiger von Eisenhart-Rothe (TUM University Hospital), and Daniel Roth (HEX, TUM)
...
On this paper Shiyu Li worked with Hannah Schieber (HEX, TUM), Kristoffer Waldow (TH Köln, HEX, TUM), Julian Kreimeier (HEX, TUM), Benjamin Busam (TUM), and Daniel Roth (HEX, TUM)
